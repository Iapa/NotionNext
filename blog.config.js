...
const BLOG = {
  ...
  SINCE: process.env.NEXT_PUBLIC_SINCE || 2013, // e.g if leave this empty, current year will be used.
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个产品兼开发者, Hi，我是一个爱折腾的人,欢迎来到我的博客🎉',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://f.appa.me', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 技术', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'hello@appa.me', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || 'https://weibo.com/leijun', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://x.com/Masku77', // 你的twitter个人主页
